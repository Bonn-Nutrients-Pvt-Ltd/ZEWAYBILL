...
************************************************************************************************
    ...
    IF wa_ship-TaxNumber3 IS NOT INITIAL AND wa_irn-irnno IS INITIAL AND lv_sum IS INITIAL AND ( printform = 'stoOriginal' OR printform = 'stoDuplicate' OR printform = 'stoOffice' ).
